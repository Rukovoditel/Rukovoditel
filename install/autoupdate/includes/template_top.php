<?php
  ...
  {
    case 'ru':
        define('TEXT_APP_TITLE','Руководитель | Автоматическое обновление базы данных с ' . TEXT_UPDATE_VERSION_FROM .' до ' . TEXT_UPDATE_VERSION_TO);
      ...
      break;
    default:
        define('TEXT_APP_TITLE','Rukovoditel | Database Auto Update from ' . TEXT_UPDATE_VERSION_FROM . ' to' . TEXT_UPDATE_VERSION_TO);
...
<link href="../../template/plugins/font-awesome/css/font-awesome.min.css?v=4.5.0" rel="stylesheet" type="text/css"/>

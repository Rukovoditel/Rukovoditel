...
define('TEXT_MENU_ICON_TITLE_TOOLTIP','Enter Font Awesome icon name, for example: fa-bell. <a href="https://fontawesome.com/v4.7.0/icons/" target="_blank">See list of available icons</a>');
...
define('TEXT_FORMS_FIELDS_DISPLAY_RULES_INFO','For fields of type Drop Down you have the ability to customize the display of fields, depending on the selected list values. <a href="https://www.rukovoditel.net/forms-fields-rules.html" target="_blank">Read more</a>');
...
<p>Also we recommend you to visit the "Documentation" page on our <a href="http://blog.rukovoditel.net/documentations/" target="_blank">blog</a>. There you will find various tips on setting up the system.</p>
...
define('TEXT_ENTITY_ACCESS_INFO_EXTRA','<br>"Views All. Actions with Assigned" allows you to perform an action only with the assigned records.<br>"Update Selected" will be available when the Extension is installed. <a href="https://www.rukovoditel.net/multiple-update.html" target="_blank">More Details</a>.');
define('TEXT_CONDITION_NOT_EMPTY_VALUE','Not empty value');
define('TEXT_FIELDTYPE_AUTOSTATUS_TITLE','Automatic status');
define('TEXT_FIELDTYPE_AUTOSTATUS_TOOLTIP','After creating the field, create the necessary statuses by clicking on the field name in the field list. The status will be set automatically when creating or editing an entry, depending on the filters configured. <a href="https://www.rukovoditel.net/ru/automatic-status.html" target="_blank">Read more</a>.');
...
define('TEXT_EXTENSION_FEATURES_LIST','Automation of business processes,Public Forms and Rest API,Payment modules,Currencies, SMS notification,Integration with Dropbox,Online chat,Timeline Report,Pivot Table Reports,Multiple update,Common Reports,Complex calculations,Gantt Chart,Сalendar,Charts and Graphs,Funnel Chart,Info Pages,Time Tracking and Timer Reports,Templates');
...
define('TEXT_USERS_ALERTS_INFO','On this page you have the ability to create alerts for selected users or groups of users. <a href="https://www.rukovoditel.net/users-alerts.html" target="_blank">Read more</a>.');
...
define('TEXT_CHOICES_VALUE_INFO','The value can be used in formula calculations. <a href="https://www.rukovoditel.net/formula-calculations.html" target="_blank">Read more</a>');
...
define('TEXT_JS_FORMULA_TIP','Use [Field ID] to setup field value in formula. Example: ([36]+[54])/2. Where 36 and 54 are ID of numeric fields. <a href="https://www.rukovoditel.net/formula-calculations.html" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_ACCESS_ALLOCATION_RULES_INFO','On this page you have the ability to configure user access depending on the values of the selected field. <a href="https://www.rukovoditel.net/access-rules.html" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_REPORTS_GROUPS_INFO','Group reports by a specific entity or data and display them on a separate page. <a href="https://www.rukovoditel.net/reports.html" target="_blank"><u>Read more.</u></a>');

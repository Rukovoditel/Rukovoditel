...
define('TEXT_MENU_ICON_TITLE_TOOLTIP','Введите название иконки из библиотеки Font Awesome, например: fa-bell. <a href="https://fontawesome.com/v4.7.0/icons/" target="_blank">Просмотреть список доступных иконок</a>');
...
define('TEXT_FORMS_FIELDS_DISPLAY_RULES_INFO','Для полей типа список у вас есть возможность настроить отображение полей, в зависимости от выбранного значения списка. <a href="https://www.rukovoditel.net/ru/forms-fields-rules.html" target="_blank">Подробнее</a>');
...
<p>Если вы еще не успели ознакомиться с системой более подробно, рекомендуем посетить раздел "Документация" на нашем блоге <a href="http://blog.rukovoditel.net/ru/documentation/" target="_blank">blog.rukovoditel.net</a>. Там вы найдете различные советы по настройке системы.</p>
...
define('TEXT_ENTITY_ACCESS_INFO_EXTRA','<br>Опция "Просмотр всех. Действия с назначенными" разрешает выполнять действия только с назначенными записями.<br>Опция "Обновить выбранные" будет доступна при установленном дополнении. <a href="https://www.rukovoditel.net/ru/multiple-update.html" target="_blank">Подробнее.</a>');
define('TEXT_CONDITION_NOT_EMPTY_VALUE','Непустое значение');
define('TEXT_FIELDTYPE_AUTOSTATUS_TITLE','Автоматический статус');
define('TEXT_FIELDTYPE_AUTOSTATUS_TOOLTIP','После создания поля, создайте необходимые статусы, нажав на имя поля в списке полей. Статус будет устанавливаться автоматически при создании или редактировании записи, в зависимости от настроенных фильтров. <a href="https://www.rukovoditel.net/ru/automatic-status.html" target="_blank">Подробнее</a>.');
...
define('TEXT_EXTENSION_FEATURES_LIST','Автоматизация бизнес процессов,Публичные формы и Rest API,Платежные модули,Валюты,СМС уведомление,Интеграция с Dropbox и Яндекс.Диск,Онлайн чат,Отчеты по шкале времени,Сводные отчеты,Множественное обновление,Общие отчеты,Сложные вычисления,Диаграмма Ганта,Календарь,Графики и диаграммы, Воронкообразная диаграмма, Информационные страницы,Учет времени и временные отчеты,Шаблоны');
...
define('TEXT_USERS_ALERTS_INFO','На этой странице у вас есть возможность создавать оповещения для выбранных пользователей  или групп пользователей. <a href="https://www.rukovoditel.net/ru/users-alerts.html" target="_blank">Подробнее</a>.');
...
define('TEXT_CHOICES_VALUE_INFO','Значение может использоваться в вычислениях формулы. <a href="https://www.rukovoditel.net/ru/formula-calculations.html" target="_blank">Подробнее</a>');
...
define('TEXT_JS_FORMULA_TIP','Используйте [ID поля] для установки значения поля в формуле. Пример: ([36]+[54])/2 где 36 и 54 - идентификаторы числовых полей. <a href="https://www.rukovoditel.net/ru/formula-calculations.html" target="_blank"><u>Подробнее.</u></a>');
...
define('TEXT_ACCESS_ALLOCATION_RULES_INFO','На этой странице у вас есть возможность настроить доступ пользователей в зависимости от значений выбранного поля. <a href="https://www.rukovoditel.net/ru/access-rules.html" target="_blank"><u>Подробнее.</u></a>');
...
define('TEXT_FIELDTYPE_TODO_LIST_TOOLTIP','Специальный тип поля позволяющий вам создавать список дел (подзадач) в рамках одной задачи. Каждая подзадача вводится с новой строчки в текстовом поле. Символ * в начале строки означает, что подзадача завершена. <a href="https://www.rukovoditel.net/ru/todo-list.html" target="_blank"><u>Подробнее</u></a>.');
...
define('TEXT_REPORTS_GROUPS_INFO','Группируйте отчеты по определенной сущности или данным и выводите их на отдельной странице. <a href="https://www.rukovoditel.net/ru/reports.html" target="_blank"><u>Подробнее</u></a>');
